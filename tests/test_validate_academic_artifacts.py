...
def build_valid_summary():
    return {
        ...
        "metrics": {
            ...
            "single_event_doc_role_micro_f1": 0.66,
            "multi_event_doc_role_micro_f1": 0.44,
            ...
            "academic_metrics": {
                "doc_ee": {
                    ...
                    "gold_event_multiplicity_breakdown": {
                        "single_event": {"doc_role": {"MicroF1": 0.66}},
                        "multi_event": {"doc_role": {"MicroF1": 0.44}},
                        "zero_gold": {"support_samples": 0},
                    },
                },
                "legacy_dueefin": {
