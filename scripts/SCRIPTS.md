...
- Academic multi-seed eval:
  - `bash scripts/run_eval_academic.sh --checkpoint logs/DuEE-Fin/checkpoints/exp1 --split dev --eval-mode both`
- Debug pipeline:
...
Examples:
- `bash scripts/run_eval_academic.sh --checkpoint logs/DuEE-Fin/checkpoints/exp1 --split dev --eval-mode both`
- `bash scripts/run_eval_academic.sh --checkpoint logs/DuEE-Fin/checkpoints/exp1 --num-samples 200 --seeds 3407,3408,3409`
